...
export const createOrder = async (req, res) => {
    ...
    console.log("Create Order Start Time",startTime)
    const { user_id, product_id, quantity } = req.body;

    try {
        if (!user_id || !product_id || !quantity) {
            return res.status(400).json({ success:false, message: "user id, product id and quantity required" });
        }
        ...
        console.log("Create Order End Time",endTime)
...
export const getUserOrders = async (req, res) => {
    const startTime =  Date.now();
    console.log("Get Order Start Time",startTime)
    ...
    try {
        ...
        const endTime =  Date.now()
        console.log("Get Order End Time",endTime)
        console.log("Time",endTime-startTime)
...
export const getAllOrders = async (req, res) => {
    //Start Time
    const startTime =  Date.now()
    console.log("Get One Order Start Time",startTime)
    try {
        ...
        //End Time
        const endTime =  Date.now()
        console.log("Get One Order End Time",endTime)
        console.log("Time",endTime-startTime)
